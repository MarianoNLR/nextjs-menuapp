...
export function FoodDetailsModal(props) {
    ...
    const addToOrder = () => {
        ...
        if (order) { //Si existe simplemente agrego o modifico
            order.items[props.data.id] = {dish: {id: props.data.id, name: props.data.name, description: props.data.description, unitPrice: props.data.price, restaurantId: props.data.Restaurant.id}, quantity, restaurantId: props.data.Restaurant.id}
